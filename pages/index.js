    ...
    <div>
      ...
      <Container sm>
        <Row css={{ marginTop: '$3', marginBottom: '$3' }}>
          <Text h3>Latest Relisted NFT&apos on HardHat</Text>
        </Row>
      ...
      <Container sm>
        <Row css={{ marginTop: '$3', marginBottom: '$3' }}>
          <Text h3>Available NFT&apos on HardHat</Text>
        </Row>
        <Grid.Container gap={1} justify="flex-start">
          {
        ...
        <Container sm>
        <Row css={{ marginTop: '$3', marginBottom: '$3' }}>
          <Text h3>Latest Relisted NFT&apos on </Text><img src='ethereumlogo.png' style={{ width: '190px', height: '45px', marginLeft: '4px' }} />
        </Row>
        <Grid.Container gap={1} justify="flex-start">
          {
      ...
      <Container sm>
        <Row css={{ marginTop: '$3', marginBottom: '$3' }}>
          <Text h3>Latest NFT&apos on</Text><img src='ethereumlogo.png' style={{ width: '190px', height: '45px', marginLeft: '4px' }} />
        </Row>
        <Grid.Container gap={1} justify="flex-start">
          {
        ...
        <Container sm>
        <Row css={{ marginTop: '$3', marginBottom: '$3' }}>
          <Text h3>Latest Relisted NFT&apos on </Text><img src='bsc.png' style={{ width: '190px', height: '45px', marginLeft: '4px' }} />
        </Row>
        <Grid.Container gap={1} justify="flex-start">
          {
      ...
      <Container sm>
        <Row css={{ marginTop: '$3', marginBottom: '$3' }}>
          <Text h3>Latest NFT &apos on</Text><img src='bsc.png' style={{ width: '190px', height: '45px', marginLeft: '4px' }} />
        </Row>
        <Grid.Container gap={1} justify="flex-start">
          {
        ...
        <Container sm>
        <Row css={{ marginTop: '$3', marginBottom: '$3' }}>
          <Text h3>Latest Relisted NFT&apos on </Text><img src='polygonwhite.png' style={{ width: '190px', height: '45px', marginLeft: '4px' }} />
        </Row>
        <Grid.Container gap={1} justify="flex-start">
          {
      ...
      <Container sm>
        <Row css={{ marginTop: '$3', marginBottom: '$3' }}>
          <Text h3>Latest NFT&apos on</Text><img src='polygonwhite.png' style={{ width: '190px', height: '45px', marginLeft: '4px' }} />
        </Row>
        <Grid.Container gap={1} justify="flex-start">
          {
